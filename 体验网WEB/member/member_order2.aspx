<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="member_order2.aspx.cs" Inherits="Adpost.YCH.WEB.member.member_order2" %>
    	...
    	<div class="member_conent">
            ...
            <div class="member_order">
            	<table>
                    ...
                    <tr>
                    	<td align="right" class="member_order_td1">份数	</td>
                        <td><asp:Literal ID="Literal1" runat="server"></asp:Literal>份</td>
                    </tr>
                    <tr>
                    	<td align="right" class="member_order_td1">人数	</td>
                        <td><asp:Literal ID="Literal2" runat="server"></asp:Literal>人</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                    	<td align="right" class="member_order_td1" colspan="2">报名信息</td>
                    </tr>
                    <tr>
                    	<td align="right" class="member_order_td1" colspan="2"><table id="tblFinaPlan" class="table_C autoAdd">
                                      <tr>
                                        <th>姓名</th>
                                        <th>性别</th>
                                        <th>身份证号</th>
