<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IntegralShop.aspx.cs" Inherits="Adpost.YCH.WEB.member.IntegralShop" %>
...
<section class="member_body">
	<div class="member_main">
    	<div class="member_title">
        	<a href="member_info.aspx">会员信息</a><a href="member_order_list.aspx">我的订单</a><a href="member_collect.aspx">我的收藏</a><a href="member_line.aspx">我的线路</a><a href="member_blogs.aspx">我的游记</a><a href="member_guangyin.aspx">我的光影</a><a href="IntegralShop.aspx" class="on">积分商城</a>
        </div>
    	<div class="member_conent">
            ...
            <asp:Repeater ID="rptItemsList" runat="server">
              ...
              <li>
                ...
                <h3><%#Eval("good_name") %></h3>
                <h3>积分：<span class="fontred"><%#Eval("price") %></span></h3>
