<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="member_guangyin.aspx.cs" Inherits="Adpost.YCH.WEB.member.member_guangyin" %>
...
<section class="member_body">
	<div class="member_main">
    	<div class="member_title">
        	<a href="member_info.aspx">会员信息</a><a href="member_order_list.aspx">我的订单</a><a href="member_collect.aspx">我的收藏</a><a href="member_line.aspx">我的线路</a><a href="member_blogs.aspx">我的游记</a><a href="member_guangyin.aspx" class="on">我的光影</a><a href="IntegralShop.aspx">积分商城</a>
        </div>
                    ...
                    <ul>
                    	<li>
                        	<div class="collect_lt left">
                            	<img width="405" height="185" src="<%#Adpost.YCH.WEB.Common.NoPhotoDefault(Convert.ToString(Eval("photoaddress"))) %>">
                                <p><a href="member_guangyindel.aspx?Id=<%#Eval("Id") %>">删除我的光影</a></p>
                            </div>
...
<div id="Monver">
                        <h2>发表光影<span id="close"></span></h2>
                        <table>
                                <tr>
                                    <td width="20%" class="theme_td1">光影标题</td>
                                    <td width="80%"><input type="text" class="lodge_input1" name="title"></td>
                                </tr>
                                
                                <tr>
                                    <td class="theme_td1">光影图片</td>
                                    <td><img src="../images/about_scenic_img3.jpg"> <uc1:UploadControl runat="server" ID="UploadControl1" IsUploadMore="false" IsUploadSelf="true" /></td>
                                </tr>
                                <tr>
                                    <td class="theme_td1">光影简介</td>
                                    <td><textarea class="lodge_area1" name="content"></textarea></td>
                                </tr>
                                <tr>
                                    <td colspan="2" class="theme_td1"><asp:Button ID="btnSave" CssClass="theme_input3" runat="server" Text="提 交" OnClick="btnSave_Click" /><input type="button" class="theme_input4" value="取 消"></td>
                                </tr>
                            </table>
