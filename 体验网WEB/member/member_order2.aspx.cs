...
{
    public partial class member_order2 : BasePage
    {
        ...
        private void InitInfo()
        {
            ...
            if (!String.IsNullOrWhiteSpace(Id))
            {
                ...
                if (model != null)
                {
                    ...
                    this.Literal1.Text = model.childrennum.ToString();
                    this.Literal2.Text = model.num.ToString();
                    //this.ltrContact.Text = model.linkman + "/" + model.customerphone + "/" + model.customeraddress;
                    this.ltrRemark.Text = model.remark;
                    if (model.ActivitiyPersons != null) {
                        this.rptList.DataSource = model.ActivitiyPersons;
