<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="member_order_list.aspx.cs" Inherits="Adpost.YCH.WEB.member.member_order_list" %>
	...
	<div class="member_main">
    	...
    	<div class="shopping_list_leftmenu">
            <ul>
                ...
                <li><a href="member_order_list.aspx?Type=<%=(int)Adpost.YCH.BLL.订单类型.活动 %>"<%=Adpost.YCH.Utility.Utils.GetInt(Adpost.YCH.Utility.Utils.GetQueryStringValue("Type"))==(int)Adpost.YCH.BLL.订单类型.活动?" class=\"on\"":"" %>>活动订单</a></li>
            </ul>
        </div>
    
    	<div class="member_title">
        	<a href="member_info.aspx">会员信息</a><a href="member_order_list.aspx" class="on">我的订单</a><a href="member_collect.aspx">我的收藏</a><a href="member_line.aspx">我的线路</a><a href="member_blogs.aspx">我的游记</a><a href="member_guangyin.aspx">我的光影</a><a href="IntegralShop.aspx">积分商城</a>
        </div>
    	<div class="member_conent">
                    ...
                    <div class="pane_search_into right">
                        <table>
                            <tr>
                                    ...
                                    <td style=" vertical-align:bottom"><a href="javascript:window.location='member_order_list.aspx?Type=<%=Adpost.YCH.Utility.Utils.GetQueryStringValue("Type") %>&KeyWord='+escape($('#keyWord').val());"><img src="../images/icons11.png"></a></td>
                                </tr>
                        </table>
                    </div>
                </div>
            ...
            <div class="member_order_list">
            	<table>
                	<tr>
                        <td width="6%" class="order_list_td1">单号</td>
                        <td width="39%" class="order_list_td1">订单名称</td>
                        <td width="12%" class="order_list_td1">日期</td>
                        <td width="8%" class="order_list_td1">金额</td>
                        <td width="9%" class="order_list_td1">支付方式</td>
                        <td width="9%" class="order_list_td1">状态</td>
                        <td width="17%" class="order_list_td1">操作</td>
                    </tr>
                     <asp:Repeater ID="rptList" runat="server">
                        <ItemTemplate>
                    <tr>
                    	<td><%#Eval("code") %></td>
                        <td class="order_list_td2"><%#Eval("productname") %></td>
                        <td><%#Eval("create_date","{0:yyyy-MM-dd}") %></td>
                        <td>&yen;<%#Eval("realamount") %></td>
                        <td><%#(Adpost.YCH.BLL.支付类型)Convert.ToInt32(Eval("paytype")) %></td>
                        <td><%#(Adpost.YCH.BLL.订单状态)Convert.ToInt32(Eval("orderstatus")) %></td>
                        <td><%#Op(Eval("id").ToString(), (Adpost.YCH.BLL.订单状态)Convert.ToInt32(Eval("orderstatus")), (Adpost.YCH.BLL.订单类型)Convert.ToInt32(Eval("ordertype")))%></td>
                    </tr>
                    </ItemTemplate>
                    </asp:Repeater>
                </table>
