...
<section class="news_main1">
	<div class="news_event">
    	<div class="news_event_head">特色活动<span>EVENT</span></div>
        <div class="tabPanel">
        	<div class="tabPane2">
            	<ul>
                    <li class="hit"><a href="news_event.aspx">火热开展中</a></li>
                    <li><a href="news_endevent.aspx">已结束的活动</a></li>
                </ul>
            </div>            
            <div class="panes">
                <div class="pane" style="display:block;">
                   ...
                   <div class="pane_content_list_show">
                   		<div class="pane_content_list_show1">
                            ...
                            <div><span style="line-height: 55px; padding-right: 200px;" class="right">共<asp:Literal ID="ltrallowjointimelimit" runat="server"></asp:Literal>份，<!--本次活动已报名<asp:Literal ID="ltrJoinCount" runat="server"></asp:Literal>次，共<span style="color: #74CA31; font-size: 18px;"><asp:Literal ID="ltrJoinPeoNumber" runat="server"></asp:Literal></span>人</span>--><asp:Literal ID="ltrShowBtn" runat="server"></asp:Literal></div>
                        ...
                        <div id="Monver">
                            ...
                            <table>
                                ...
                                <tr>
                                    <td class="theme_td1">预计参加时间</td>
                                    <td><input type="text" name="txtPlanTime" class="theme_input1" id="txtPlanTime" value="<%=StartDate %>" /></td>
                                </tr>
                                <!--
                                <tr>
                                ...
                                -->
                                <tr>
                                    <td class="theme_td1">份数</td>
                                    <td><input type="text" name="txtFenNumber" class="theme_input2">&nbsp;&nbsp份*</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  <td colspan="2">请填写参加活动人员信息，至少一人填写完整信息</td></tr>
                                <tr>
                                  <td colspan="2">
                                    <table id="tblFinaPlan" class="table_C autoAdd">
                                      <tr>
                                        <th>姓名</th>
                                        <th>性别</th>
                                        <th>身份证号</th>
...
<script type="text/javascript">
    $(function () {
        ...
        $("#btnEventJoinClick").click(function () {
            $.ajax({
                type: "get",
                cache: false,
                url: "news_eventshow.aspx?doType=IsCheck&Id=<%=Request.QueryString["Id"] %>",
                dataType: "json",
...
<script type="text/javascript">
    $(function () {
       ...
       // $("#tblFinaPlan").autoAdd({ tempRowClass: "tempRow", addButtonClass: "addbtnFinaPlan", delButtonClass: "delbtnFinaPlan" });
    });
</script>
