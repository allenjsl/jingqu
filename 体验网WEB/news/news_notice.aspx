<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="news_notice.aspx.cs" Inherits="Adpost.YCH.WEB.news.news_notice" %>
        ...
        <div class="tabPanel">
            <div class="panes">
                <div class="pane" style="display:block;">
                	<div class="pane_title"><span>通知公告</span></div>
                        ...
                        <div class="pane_search_into left">
                        	<table>
                            	<tr>
                                    ...
                                    <td style=" vertical-align:bottom"><a href="javascript:window.location='news_notice.aspx?KeyWord='+escape($('#keyWord').val());"><img src="../images/icons11.png"></a></td>
                                </tr>
                            </table>
                        </div>
                    </div>
                    ...
                    <div class="pane_content_list">                    	
                    	<a href="news_noticeshow.aspx?Id=<%#Eval("id") %>"><%#ImgSplit(Convert.ToString(Eval("imglist"))) %></a>
                        <h2><a href="news_noticeshow.aspx?Id=<%#Eval("id") %>"><%#Eval("title") %></a></h2>
                        ...
                        <div class="pane_con_share2"><a href="/mycollect.aspx?TypeId=<%=(int)Adpost.YCH.BLL.收藏类别.通知公告 %>&Id=<%#Eval("id") %>&RUrl=<%=Server.UrlEncode(Request.Url.ToString()) %>"><img src="../images/flow_list1.png"></a></div>                    
                    </div>
