<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="news_information.aspx.cs" Inherits="Adpost.YCH.WEB.news.news_information" %>
        ...
        <div class="tabPanel">
            <div class="panes">
                <div class="pane" style="display:block;">
                	<div class="pane_title"><span>新闻资讯</span></div>
                        ...
                        <div class="pane_search_into left">
                        	<table>
                            	<tr>
                                    ...
                                    <td style=" vertical-align:bottom"><a href="javascript:window.location='news_information.aspx?KeyWord='+escape($('#keyWord').val());"><img src="../images/icons11.png"></a></td>
                                </tr>
                            </table>
                        </div>
                    </div>
                    ...
                    <div class="pane_content_list">                    	
                    	<a href="news_informationshow.aspx?Id=<%#Eval("id") %>"><%#ImgSplit(Convert.ToString(Eval("imglist"))) %></a>
                        <h2><a href="news_informationshow.aspx?Id=<%#Eval("id") %>"><%#Eval("title") %></a></h2>
                        <p><%#Adpost.YCH.Utility.Utils.GetText(Adpost.YCH.Utility.StringValidate.LoseHtml(Convert.ToString(Eval("webdesc"))),150,true) %></p>  
                        <div class="pane_con_share1"><div class="bdsharebuttonbox"><a href="#" class="bds_more" data-cmd="more"></a><a href="#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a><a href="#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a><a href="#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a><a href="#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a><a href="#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a></div>
                        </div>
                        <div class="pane_con_share2"><a href="/mycollect.aspx?TypeId=<%=(int)Adpost.YCH.BLL.收藏类别.新闻资讯 %>&Id=<%#Eval("id") %>&RUrl=<%=Server.UrlEncode(Request.Url.ToString()) %>"><img src="../images/flow_list1.png"></a></div>                    
                    </div>
