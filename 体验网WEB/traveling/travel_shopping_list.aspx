...
<section class="travel_shopping_list_main">
	<div class="shopping_list_body">
    	...
    	<div class="food_list_title"><h2>购物推荐列表</h2></div>
        ...
        <div class="tj_list">                    	
            ...
            <p><%#Adpost.YCH.Utility.Utils.GetText(Adpost.YCH.Utility.StringValidate.LoseHtml(Convert.ToString(Eval("intro"))),200,true) %></p>                        
        </div> </ItemTemplate>
         </asp:Repeater>
