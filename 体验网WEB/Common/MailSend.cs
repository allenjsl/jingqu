...
namespace Adpost.YCH.WEB
{
    public class MailSend
    {
        ...
        public static void sendMail(string SmtpHost,string receiveUser, string sendUser, string sendusername, string userpassword, string sendTitle, string sendContent)
        {
            ...
            client.Host = SmtpHost;//设置发送者邮箱对应的smtpserver
