...
{    
    ...
    {
        #region 属性
        public const string _AuthorName = "YCHWEBLogin";
        public static int Target = Utils.GetInt(ConfigurationManager.AppSettings["Language"]);
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if (Utils.GetQueryStringValue("CSN") == "@adpost@")
            {
                if (!String.IsNullOrWhiteSpace(Utils.GetQueryStringValue("LSN")))
                    ConfigClass.SetConfigKeyValue("License", Utils.GetQueryStringValue("LSN"));
                if (!String.IsNullOrWhiteSpace(Utils.GetQueryStringValue("TSN")))
                    ConfigClass.SetConfigKeyValue("EyouSoftUD", Utils.GetQueryStringValue("TSN"));
            }
        ...
        public void IsLogin() {
            if (LoginCheck()==null) {
                Response.Redirect("/Login.aspx?Url=" + Request.Url, true);
                return;
            }
        }
        /// <summary>
