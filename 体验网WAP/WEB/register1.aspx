		...
		<div class="register">
            <table>
            	<Tr>
                    ...
                    <td><input type="text" class="register_input" id="username"><p id="usernameTip"></p></td>
                </Tr>
                <Tr>
                ...
                <tr>
                    ...
                    <td><input type="text" class="register_input" id="usermail"><p id="usermailTip"></p></td>
                </tr>
                <tr>
                	<td colspan="2"><input type="button"  class="login_btn" value="提 交"><input type="button" class="login_btn1" value="重 置"></td>
                </tr>
            </table>
        </div>
	</div>
