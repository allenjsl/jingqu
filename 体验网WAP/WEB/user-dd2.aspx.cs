...
{
    public partial class user_dd2 : BasePage
    {
        ...
        protected string Op(string Id, 订单状态 Stat)
        {
            ...
            {
                return "<a href=\"javascript:window.open('/Alipay/default.aspx?OrderId=" + Id + "')\">支付</a><br /><a href=\"Member_Order_Del.aspx?Id=" + Id + "&Type=" + Utils.GetQueryStringValue("Type") + "\">删除</a>";
            }
        }
    }
}