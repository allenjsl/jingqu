<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bandao-jiudian1.aspx.cs" Inherits="Adpost.YCH.WAP.WEB.bandao_jiudian1" %>
		...
		<div class="in-main">
			...
			<ul class="in-it-list">
				...
				<li class="in-it-items">
					<a href="bandao-jiudian.aspx?Id=<%#Eval("hotspot_id") %>">
						<img src="<%#Adpost.YCH.WAP.Common.PhotoSplit(Convert.ToString(Eval("coverphoto")),0) %>" class="in-it-img">
						<h3 class="in-it-title"><%#Eval("hotspot_name") %><i class="icon icon-hot"></i></h3>
						<p class="in-it-text"><%#Adpost.YCH.Utility.Utils.GetText2(Adpost.YCH.Utility.StringValidate.LoseHtml(Convert.ToString(Eval("intro"))), 20, true)%></p>
					</a>
				</li>
                        </ItemTemplate>
         </asp:Repeater>
