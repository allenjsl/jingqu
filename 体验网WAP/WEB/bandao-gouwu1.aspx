<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bandao-gouwu1.aspx.cs" Inherits="Adpost.YCH.WAP.WEB.bandao_gouwu1" %>
		...
		<div class="in-main">
			...
			<ul class="in-it-list">
				...
				<li class="in-it-items">
					<a href="bandao-gouwu.aspx?Id=<%#Eval("hotspot_id") %>">
