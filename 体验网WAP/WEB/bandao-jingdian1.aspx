<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bandao-jingdian1.aspx.cs" Inherits="Adpost.YCH.WAP.WEB.bandao_jingdian1" %>
...
<div class="outer-wrap borderBox">
	...
	<div class="inner-wrap borderBox">
		...
		<div class="in-nav jid-nav posR">
			<!--load begin-->
			<div id="fmnavObj"></div>
			<script>
			    $(function () {
			        $("#fmnavObj").load("tjNav.aspx", function () {
			            $(".in-nav-box li").eq(5).addClass("active");
			        });
			    });
			</script>
			<!--load end-->
		...
		<div class="in-main">
			<h2 class="in-h2 jid-h2 icon"></h2>
			<ul class="in-img-list in-img-two-list ">
                <asp:Repeater ID="rptList" runat="server">
                    <ItemTemplate>
				<li class="in-img-items borderBox">
                <a href="bandao-jingdian.aspx?Id=<%#Eval("hotspot_id") %>">
						<div class="in-img-img posR">
							<img src="<%#Adpost.YCH.WAP.Common.NoPhotoDefault(Convert.ToString(Eval("coverphoto"))) %>" >
						</div>
						<h3 class="in-img-title"><%#Eval("hotspot_name") %></h3></a>
				</li> </ItemTemplate>
                </asp:Repeater>
			</ul>
		</div>
