<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bandao-gouwu.aspx.cs" Inherits="Adpost.YCH.WAP.WEB.bandao_gouwu" %>
...
<header class="header center">
	<div class="hd-back font16"><i class="yc-box yc-icon yc-close"></i><i class="yc-box yc-icon yc-close"></i>
	...
	<div class="inner-wrap borderBox">
		...
		<div class="in-nav gw-nav posR">
		 ...
		 <div class="in-main">
			...
			<ul class="in-it-list clearfix">
                <asp:Repeater ID="rptItemsList" runat="server">
                    <ItemTemplate>
				<li class="jnp-li">
					<!--<a class="yuding-btn" href="gouwu-view.aspx?Id=<%#Eval("Id") %>">-->
						<img src="<%#Adpost.YCH.WAP.Common.NoPhotoDefault(Convert.ToString(Eval("webphoto"))) %>">
						<h3 class="in-it-title"><%#Eval("good_name") %>
<!--<i class="icon icon-hot"></i>-->
</h3>
						<!--<p class="in-it-text"><%#Adpost.YCH.Utility.Utils.GetText2(Convert.ToString(Eval("webdesc")),200,true) %></p>
