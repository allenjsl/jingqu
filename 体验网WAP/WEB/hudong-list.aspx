	...
	<div class="inner-wrap borderBox">
		...
		<ul class="hd-list">
			<asp:Repeater ID="rptList" runat="server">
                        <ItemTemplate>
			<li class="big posR">
				<a href="gyview.aspx?Id=<%#Eval("Id") %>">
					<img width="405" height="185" src="<%#Adpost.YCH.WAP.Common.NoPhotoDefault(Convert.ToString(Eval("photoaddress"))) %>" border="0">
				</a>
				<div class="posA hd-text">
					<a href="gyview.aspx?Id=<%#Eval("Id") %>"><p><%#Eval("photoname") %></p><p><%#Eval("create_user_id")%></p></a>
				</div>
			</li>
			 </ItemTemplate>
                    </asp:Repeater>
