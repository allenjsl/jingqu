<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bandao-xianlu1.aspx.cs" Inherits="Adpost.YCH.WAP.WEB.bandao_xianlu1" %>
...
<div class="outer-wrap borderBox">
	...
	<div class="inner-wrap borderBox">
		...
		<div class="in-nav xl-nav posR">
			<!--load begin-->
			<div id="fmnavObj"></div>
			<script>
			    $(function () {
			        $("#fmnavObj").load("tjNav.aspx", function () {
			            $(".in-nav-box li").eq(4).addClass("active");
			        });
			    });
			</script>
			<!--load end-->
		...
		<div class="in-main">
			...
			<ul class="th-list">
				...
				<li class="posR">
						...
						<a class="posA" href="bandao-xianluview.aspx?Id=<%#Eval("Id") %>">点击查看详情</a>
				</li></ItemTemplate>
                    </asp:Repeater> 
			</ul>
		</div>
