        ...
        <div class="main_content">
            <div class="main_content_top">
                <table>
                    ...
                    <tr>
                    	<td>行程日期：</td>
                        <td><input type="text" name="tourdate" id="dp2"></td>
                    </tr>
                </table>
            </div>
...
<script>
    ...
    $(function () {
        ...
        $(document).on("click", ".dayBox .addDay", function () {
            ...
            var $html = '<div class="dayBox" data-id="' + i + '"><h1 class="on"  data-id="' + i + '">D<i class="nums">' + i + '</i></h1><ul></ul><i class="dayDel">删除</i><h2 class="addDay">+</h2></div>';
            $parent.after($html);
