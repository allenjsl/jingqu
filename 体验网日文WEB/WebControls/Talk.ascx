...
<div class="travel_raiders_text_message1">
            <table>
                ...
                <tr>
                    ...
                    <td width="32%" class="message_td1"><asp:PlaceHolder ID="phLogin" runat="server"><a href="/Login.aspx" target="_blank">ログイン</a>|<a href="/Register.aspx" target="_blank">新規取得</a></asp:PlaceHolder></td>                        
                    <td width="14%"></td>
                </tr>
