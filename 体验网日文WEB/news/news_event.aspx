<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="news_event.aspx.cs" Inherits="Adpost.YCH.WEB.news.news_event" %>
...
<section class="news_main1">
	<div class="news_event">
    	<div class="news_event_head">イベント<span>EVENT</span></div>
        <div class="tabPanel">
        	<div class="tabPane2">
            	<ul>
                    <li class="hit"><a href="news_event.aspx">火热開催中</a></li>
                    <li><a href="news_endevent.aspx">終了的活动</a></li>
                </ul>
            </div>            
            <div class="panes">
                <div class="pane" style="display:block;">
                	<div class="pane_title"><span>開催中的活动</span></div>
                    <div class="pane_search">
                    	<div class="pane_search_choose left">
                        	<div class="pane_search_choose_main">タイトル</div>
                        ...
                        <div class="pane_search_into left">
                        	<table>
                            	<tr>
                                    ...
                                    <td style=" vertical-align:bottom"><a href="javascript:window.location='news_event.aspx?KeyWord='+escape($('#keyWord').val());"><img src="../images/icons11.png"></a></td>
                                </tr>
                            </table>
                        </div>
                    </div>
                    <asp:Repeater ID="rptList" runat="server">
                    	...
                    	<a href="news_eventshow.aspx?Id=<%#Eval("id") %>"><img width="405" height="185" src="<%#Adpost.YCH.WEB.Common.NoPhotoDefault(Convert.ToString(Eval("thumb_img"))) %>"></a>
                        ...
                        <p><%#Adpost.YCH.Utility.Utils.GetText(Adpost.YCH.Utility.StringValidate.LoseHtml(Convert.ToString(Eval("act_introduce"))),120,true) %></p>    <div class="pane_con_share1"><div class="bdsharebuttonbox"><a href="#" class="bds_more" data-cmd="more"></a><a href="#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a><a href="#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a><a href="#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a><a href="#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a><a href="#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a></div>
                        </div>
