...
{
    public partial class member_order_list : BasePage
    {
        ...
        protected string Op(string Id, 订单状态 Stat)
        {
            if (Stat == 订单状态.已支付) {
                ...
                return "<a href=\"member_order.aspx?Id=" + Id + "&Type=" + Utils.GetQueryStringValue("Type") + "\">查看</a><a href=\"Member_Order_Del.aspx?Id=" + Id + "&Type=" + Utils.GetQueryStringValue("Type") + "\">删除</a>";
            }
        }
    }
}