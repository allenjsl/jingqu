...
<section class="login_body">
  ...
  <h2>会员ログイン<span id="close"></span></h2>
  <div class="login">
      ...
      <table>
        ...
        <tr>
          <td><input type="checkbox" name="cbRember" value="1">
            记住我的ログイン<span class="login_reg">新規取得</span><span class="login_find"><a href="login_find.aspx">找回密码</a></span></td>
          <td>
              <asp:LinkButton ID="lbtnLogin" runat="server" CssClass="login_lt_btn" OnClick="lbtnLogin_Click">ログイン</asp:LinkButton></td>
        </tr>
      </table>
    </div>
