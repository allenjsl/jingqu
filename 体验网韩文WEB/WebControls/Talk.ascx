...
<div class="travel_raiders_text_message1">
            <table>
                ...
                <tr>
                    ...
                    <td width="32%" class="message_td1"><asp:PlaceHolder ID="phLogin" runat="server"><a href="/Login.aspx" target="_blank">로그인</a>|<a href="/Register.aspx" target="_blank">등록</a></asp:PlaceHolder></td>                        
                    <td width="14%"></td>
                </tr>
