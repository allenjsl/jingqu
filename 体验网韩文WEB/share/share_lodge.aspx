...
<section class="share-main1">
	<div class="share_travel">
    	<div class="share_travel_head2">의견 제의<span>COMPLAINTS & PROPOSALS</span></div>
        <div class="tabPanel">
        	<div class="tabPane3">
            	<ul>
                    <li class="hit">의견 제의</li>
                </ul>
            </div>            
            <div class="panes">
                <div class="pane" style="display:block;">
                	<div class="pane_title"><span>의견 제의</span></div>
                    <div class="share_lodge">
                    	<div class="share_lodge_btn left">我要参与</div>
                        <div id="Monver">
                        	<h2>의견 제의<span id="close"></span></h2>
                            <table>
                                	<tr>
