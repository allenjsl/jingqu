<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="share_Hotblogs.aspx.cs" Inherits="Adpost.YCH.WEB.share.share_Hotblogs" %>
...
<section class="share-main1">
	<div class="share_travel">
    	<div class="share_travel_head">반도 여행기<span>TRAVEL</span></div>
        <div class="tabPanel">
        	<div class="tabPane2">
            	<ul>
                    <li><a href="share_blogs.aspx">最新游记</a></li>
                    <li class="hit"><a href="share_Hotblogs.aspx">精品游记</a></li>
                </ul>
            </div>            
            <div class="panes">
                <div class="pane" style="display:block;">
                	<div class="pane_title"><span>精品游记</span></div>
