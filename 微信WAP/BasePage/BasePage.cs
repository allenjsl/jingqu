...
{    
    ...
    public class BasePage : System.Web.UI.Page
    {
        ...
        protected const string _OpenIdCookieName = "YCHWeixiOpenId";
        ...
        public string GetOpenId() {
            HttpCookie hc = HttpContext.Current.Request.Cookies[_OpenIdCookieName];
            if (hc != null)
            {
                if (!String.IsNullOrWhiteSpace(hc["OpenId"]))
                {
                    return hc["OpenId"];
                }
                else { return null; }
