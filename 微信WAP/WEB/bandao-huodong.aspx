<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bandao-huodong.aspx.cs" Inherits="Adpost.YCH.WAP.WEB.bandao_huodong" %>
<!doctype html>
<html lang="en">
<head runat="server">
	<meta charset="UTF-8">
...
<div class="outer-wrap borderBox">
	...
	<div class="inner-wrap borderBox">
		...
		<div class="in-main">
        <div class="in-title">
			<a class="on" href="#">开展中</a>
			<a href="bandao-huodongend.aspx">已结束</a>
		</div>
			<ul class="in-img-list">
				...
				<li class="in-img-items">
					<a href="huodong-view.aspx?Id=<%#Eval("Id") %>">
						...
						<h3 class="in-img-title"><a href="huodong-view.aspx?Id=<%#Eval("Id") %>"><%#Adpost.YCH.Utility.Utils.GetText2(Convert.ToString(Eval("act_name")), 14, true)%></a><!--<time ><%#Eval("act_startdate","{0:MM-dd}") %>至<%#Eval("act_enddate","{0:MM-dd}") %></time>--></h3>
					</a>
				</li>
                 </ItemTemplate>
                    </asp:Repeater>
