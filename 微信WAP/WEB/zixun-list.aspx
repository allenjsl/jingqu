<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="zixun-list.aspx.cs" Inherits="Adpost.YCH.WAP.WEB.zixun_list" %>
<!doctype html>
<html lang="en">
<head runat="server">
	<meta charset="UTF-8">
...
<div class="outer-wrap borderBox">
	...
	<div class="inner-wrap borderBox">
		...
		<ul class="in-tab">
			<li class="active borderBox"><a href="zixun-list.aspx">新闻资讯</a></li>
			<li class="borderBox"><a href="notice-list.aspx">通知公告</a></li>
		</ul>
		<div class="in-main">
			<ul class="in-it-list">
