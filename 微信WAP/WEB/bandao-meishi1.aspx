<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bandao-meishi1.aspx.cs" Inherits="Adpost.YCH.WAP.WEB.bandao_meishi1" %>
		...
		<div class="in-main">
			...
			<ul class="in-it-list">
				...
				<li class="in-it-items">
					<a href="bandao-meishi.aspx?Id=<%#Eval("hotspot_id") %>">
						...
						<p class="in-it-text"><%#Adpost.YCH.Utility.Utils.GetText2(Convert.ToString(Eval("oneintro")), 20, true)%></p>
					</a>
				</li>
                        </ItemTemplate>
         </asp:Repeater>
