<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SystemExpired.aspx.cs" Inherits="Enow.Finawin.Web.Install.SystemExpired" %>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			<table width="60%" border="0" align="center" cellpadding="8" cellspacing="1" bgcolor="#d0e2f5"
				...
				<tr>
					<td align="right" bgcolor="#e6f2ff">系统时间Registration码：
					</td>
