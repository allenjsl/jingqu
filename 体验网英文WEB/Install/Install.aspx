<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Install.aspx.cs" Inherits="Enow.Finawin.Web.Install.Install" %>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			<table width="60%" border="0" align="center" cellpadding="8" cellspacing="1" bgcolor="#d0e2f5"
				...
				<tr>
					<td align="right" bgcolor="#e6f2ff">Registration码：
					</td>
                ...
                <tr>
					<td align="right" bgcolor="#e6f2ff">Registration码2：
					</td>
					<td align="left" bgcolor="#ffffff">
