<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QA.aspx.cs" Inherits="Adpost.YCH.WEB.member.QA" %>
...
<section class="member_body">
	<div class="member_main">
    	<div class="member_title">
        	<a href="member_info.aspx">会员信息</a><a href="member_order_list.aspx">我的订单</a><a href="member_collect.aspx">我的收藏</a><a href="member_line.aspx">我的线路</a><a href="member_blogs.aspx" class="on">我的游记</a><a href="member_guangyin.aspx">我的光影</a><a href="member_zhangcheng.aspx">会员章程</a>
        </div>
                    ...
                    <ul>
                    	<li>
                            <div class="collect_rt left">
                            	<h3><%#Eval("question")%></h3>
                                <p><%#Adpost.YCH.Utility.Utils.GetText(Convert.ToString(Eval("anwser")), 120, true)%></p>
                            </div>
                        </li>
                    </ul>
                </div>
...
<div style="clear:both;"></div>
    <div id="Monver">
                        <h2>发表QA<span id="close"></span></h2>
                        <table>
                                <tr>
                                    <td width="20%" class="theme_td1">问题</td>
                                    <td width="80%"><input type="text" class="lodge_input1" name="title"></td>
                                </tr>                                
                                <tr>
                                    <td class="theme_td1">答案</td>
