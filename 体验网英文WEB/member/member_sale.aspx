...
<title>Member Center-我的优惠券</title>
    ...
    <nav>
      ...
      <div class="list-container">
        <ul>
          ...
          <div class="list-last">
            <p><span class="login">Mr.Burns</span><span class="register">退出</span></p>
            <p><a href="#">半岛政务网</a></p>
...
<section class="member_body">
	<div class="member_main">
    	<div class="member_title">
        	<a href="member_info.aspx">会员信息</a><a href="member_order_list.aspx">我的订单</a><a href="member_collect.aspx">我的收藏</a><a href="member_line.aspx">我的线路</a><a href="member_blogs.aspx">我的游记</a><a href="member_sale.aspx" class="on">我的优惠券</a>
        </div>
    	<div class="member_conent">
            ...
            <div class="member_sale">                    	
                <img src="../images/news_event_img3.jpg">
                <h4>邂逅阳澄湖半岛初夏的浪漫微博摄影比赛期待你的参与</h4>
                <h3>2014-09-20 至 2014-10-20</h3>
                <p>自3月份开始，随手拍“爱上半岛的N个美丽瞬间”微博摄影大赛已经吸引了大量网友参与，他们纷纷将在半岛游玩的瞬间定格，并上传到自己微博@Yangcheng Lake Tourism Resort。</p> 
                <span class="sale_span1"></span>   
                <div class="member_sale_div"></div>                    
            </div>
