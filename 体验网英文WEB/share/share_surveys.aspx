<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="share_surveys.aspx.cs" Inherits="Adpost.YCH.WEB.share.share_surveys" %>
...
<title>Jerneh service-Questionnaire investigation</title>
...
<section class="share-main1">
	<div class="share_travel">
    	<div class="share_travel_head1">Questionnaire investigation<span>SURVEYS</span></div>
        <div class="tabPanel">
        	<div class="tabPane2">
            	<ul>
                    <li class="hit"><a href="share_surveys.aspx">正在进行</a></li>
                    <li><a href="share_surveys_End.aspx">Has ended</a></li>
                </ul>
            </div>            
            <div class="panes">
                <div class="pane" style="display:block;">
                	<div class="pane_title"><span>正在进行</span></div>
        ...
        if(IsCheck){
            for(var i=0;i<ItemCount;i++){
                $.ajax({
                    type: "post",
                    cache: false,
                    url: "share_surveys.aspx?dotype=save&Id="+Id+"&ItemId="+json.ItemId[i].Id+"&v="+escape($('input:radio[name="ItemValue_'+json.ItemId[i].Id+'"]:checked').val()),
                    dataType: "json",
