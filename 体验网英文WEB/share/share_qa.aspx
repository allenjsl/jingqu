<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="share_qa.aspx.cs" Inherits="Adpost.YCH.WEB.share.share_qa" %>
...
<title>Jerneh service-Problem solving</title>
...
<section class="share-main1">
	<div class="share_travel">
    	<div class="share_travel_head2">Problem solving<span>Q & A</span></div>
        <div class="tabPanel">
        	<div class="tabPane3">
            	<ul>
                    <li class="hit">Problem solving</li>
                </ul>
            </div>            
            <div class="panes">
                <div class="pane" style="display:block;">
                	<div class="pane_title1"><span>常见Problem solving</span></div>
                            ...
                            <div class="pane_search_into left">
                                <table>
                                    <tr>
                                        ...
                                        <td style=" vertical-align:bottom"><a href="javascript:window.location='share_qa.aspx?KeyWord='+escape($('#keyWord').val());"><img src="../images/icons11.png"></a></td>
                                    </tr>
                                </table>
                            </div>
                        </div>
