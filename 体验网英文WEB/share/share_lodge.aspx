...
<title>Jerneh service-Opinions and suggestions</title>
...
<section class="share-main1">
	<div class="share_travel">
    	<div class="share_travel_head2">Opinions and suggestions<span>COMPLAINTS & PROPOSALS</span></div>
        <div class="tabPanel">
        	<div class="tabPane3">
            	<ul>
                    <li class="hit">Opinions and suggestions</li>
                </ul>
            </div>            
            <div class="panes">
                <div class="pane" style="display:block;">
                	<div class="pane_title"><span>Opinions and suggestions</span></div>
                    <div class="share_lodge">
                    	<div class="share_lodge_btn left">我要参与</div>
                        <div id="Monver">
                        	<h2>Opinions and suggestions<span id="close"></span></h2>
                            <table>
                                	<tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        	<select class="lodge_select1" name="ddlType" id="ddlType" onchange="ChangHotspotList(document.getElementById('hotspotId'),this.options[this.selectedIndex].value,0)"><option value="1">景点</option><option value="6">酒店</option><option value="3">餐馆</option></select>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
