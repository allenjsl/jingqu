...
<section class="about-main">
	<div class="travel_traffic">
    	<ul>
            ...
            <li><a href="travel_shopping_list.aspx">More</a></li>
        </ul>
    </div>
    	...
    	<ul>
        	...
        	<li>
                ...
                <div class="travel_shopping_bottom">
                	<!--<div class="travel_shopping_btn left"><a href="travel_shopping_order.aspx?Id=<%#Eval("Id") %>">立即订购</a></div>-->
                    <div class="travel_shopping_price right"><p><span><%#Eval("price") %></span>元</p></div>
                </div>
            </li>
