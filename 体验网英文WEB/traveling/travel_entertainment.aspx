<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="travel_entertainment.aspx.cs" Inherits="Adpost.YCH.WEB.traveling.travel_entertainment" %>
...
<title>半岛旅游-Entertainment recommendation</title>
...
<span class="separator"><img src="../images/title_list11.png"></span>
<h2>Entertainment recommendation</h2>
</div>
	...
	<div class="travel_traffic">
    	<ul>
            <asp:Repeater ID="rptList" runat="server">
                    <ItemTemplate>
        	<li><a href="travel_entertainment.aspx?Id=<%#Eval("hotspot_id") %>"><%#Eval("hotspot_name") %></a></li>            
            </ItemTemplate>
         </asp:Repeater><li><a href="travel_entertainment_list.aspx">More</a></li>
        </ul>
    </div>
        	...
        	<div class="travel_traffic1_main">
            	<div id="sucai">
                    <div class="travel_traffic1_ny">
                        ...
                        <div class="show_btn"><a href="travel_entertainment_show.aspx?Id=<%=Id %>">查看详情</a></div>
                    </div>
                </div>
            </div>
    ...
    <div class="travel_shopping">
    	<ul>
        	...
        	<li>
                ...
                <h2><%#Eval("name") %><a href="#"><img src="../images/icons7.png"></a></h2>
                <div id="sucai2">
                	<%#Eval("webdesc") %>
                </div>
                <div class="travel_shopping_bottom">
                	<!--<div class="travel_shopping_btn left" EID="<%#Eval("id") %>">立即订购</div>-->
                    <div class="travel_shopping_price right"><p>&yen;<span><%#Eval("price") %></span>元</p></div>
                </div>
            </li>
        ...
        <div id="Monver">
                    ...
                    <table>
                            ...
                            <tr>
                                <td colspan="2" class="theme_td1"><input type="hidden" id="hidId" name="hidId" /><asp:Button ID="btnSave" CssClass="theme_input3" runat="server" Text="提 交" OnClick="btnSave_Click" /><input type="button" class="theme_input4" value="取 消"></td>
                            </tr>
                        </table>
...
<script type="text/javascript">
    $(document).ready(function () {
        $(".travel_shopping_btn").click(function () {
