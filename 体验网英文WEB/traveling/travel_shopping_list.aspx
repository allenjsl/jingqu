<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="travel_shopping_list.aspx.cs" Inherits="Adpost.YCH.WEB.traveling.travel_shopping_list" %>
...
<section class="travel_shopping_list_main">
	<div class="shopping_list_body">
    	...
    	<div class="food_list_title"><h2>Shopping recommendation列表</h2></div>
        <asp:Repeater ID="rptList" runat="server">
                    <ItemTemplate>
        <div class="tj_list">                    	
            <a href="travel_hotel_show.aspx?Id=<%#Eval("hotspot_id") %>"><img src="<%#Adpost.YCH.WEB.Common.NoPhotoDefault(Convert.ToString(Eval("coverphoto"))) %>"></a>
            <h2><a href="travel_shopping_show.aspx?Id=<%#Eval("hotspot_id") %>"><%#Eval("hotspot_name") %></a></h2>
            <p><%#Adpost.YCH.Utility.Utils.GetText(Convert.ToString(Eval("intro")),200,true) %></p>                        
        </div> </ItemTemplate>
         </asp:Repeater>
