<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="travel_entertainment_list.aspx.cs" Inherits="Adpost.YCH.WEB.traveling.travel_entertainment_list" %>
...
<section class="travel_enter_list_main">
	<div class="food_list_body">
    	<div class="food_list_title"><h2>Entertainment recommendation列表</h2></div>
        <asp:Repeater ID="rptList" runat="server">
                    <ItemTemplate>
        <div class="tj_list">  
            <a href="travel_entertainment_show.aspx?Id=<%#Eval("hotspot_id") %>"><img src="<%#Adpost.YCH.WEB.Common.NoPhotoDefault(Convert.ToString(Eval("coverphoto"))) %>"></a>
            <h2><a href="travel_entertainment_show.aspx?Id=<%#Eval("hotspot_id") %>"><%#Eval("hotspot_name") %></a></h2>
            <p><%#Eval("oneintro") %></p>                        
        </div>
         </ItemTemplate>
         </asp:Repeater>
