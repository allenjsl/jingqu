...
<section class="travel_shopping_list_main">
	<div class="shopping_list_body">
    	...
    	<div class="shopping_list_leftmenu">
        	<ul>
            	<li><a href="travel_shopping_list.aspx">Shopping recommendation列表</a></li>
        ...
        <div class="shopping_order">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td><span class="down" onClick="update_pro_quantity('down')">-</span><input type="text" class="order_ip1" value="1" name="num"><span class="up" onClick="update_pro_quantity('up')">+</span></td>
                </tr>
                <tr>
                ...
                <tr>
                	<td colspan="2"><p class="order_p2">136</p><p class="order_p1">合计</p></td>
                </tr>
                <tr>
                	<td></td>
