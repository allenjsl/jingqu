<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="travel_shopping_show.aspx.cs" Inherits="Adpost.YCH.WEB.traveling.travel_shopping_show" %>
...
<title>Journey-Shopping recommendation</title>
...
<section class="travel_shopping_list_main">
	<div class="shopping_list_body">
    	...
    	<div class="shopping_list_leftmenu">
        	<ul>
            	<li><a href="travel_shopping_list.aspx" class="on">Shopping recommendation列表</a></li>
                <li><a href="#">确认订单</a></li>
                <li><a href="#">在线支付</a></li>
            </ul>
        </div>
        
    	<div class="food_list_title"><h2>Shopping recommendation</h2></div>
        ...
        <div class="food_list_content">
            ...
            <div class="food_list_content_rt right">
            	<div class="food_list_content_rt1"><a href="/mycollect.aspx?TypeId=<%=(int)Adpost.YCH.BLL.收藏类别.购物推荐 %>&Id=<%=Adpost.YCH.Utility.Utils.GetQueryStringValue("Id") %>&RUrl=<%=Server.UrlEncode(Request.Url.ToString()) %>"><img src="../images/flow_list1.png"></a><a href="#"><img src="../images/flow_list2.png"></a><a href="#"><img src="../images/flow_list3.png">(<asp:Literal ID="ltrTalkCount" runat="server"></asp:Literal>条)</a></div>
                ...
                <div class="pane_content_list_show1_btn1"><a href="travel_shopping_list.aspx">返回列表</a></div>
            </div>
        ...
        <div class="hotel_list">
            ...
            <div class="hotel_list1" id="firstpane">
            	...
            	<div class="menu_head current">
                	<p><span>&yen;<%#Eval("price") %></span><%#Eval("good_name") %></p>
                </div>
                <div class="menu_body">
                	<p><%#Eval("webdesc") %></p>
                    ...
                    <!--<div class="hotel_list_btn"><a  href="travel_shopping_order.aspx?Hid=<%#Eval("hotspot_id") %>&Id=<%#Eval("id") %>">预&nbsp;&nbsp;订</a></div>-->
                </div>
