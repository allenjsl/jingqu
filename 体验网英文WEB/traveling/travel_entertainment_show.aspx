<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="travel_entertainment_show.aspx.cs" Inherits="Adpost.YCH.WEB.traveling.travel_entertainment_show" %>
...
<title>Journey-Entertainment recommendation</title>
...
<section class="travel_enter_list_main">
	<div class="food_list_body">
    	<div class="food_list_title"><h2>Entertainment recommendation</h2></div>
        ...
        <div class="food_list_content">
            ...
            <div class="food_list_content_rt right">
            	<div class="food_list_content_rt1"><a href="/mycollect.aspx?TypeId=<%=(int)Adpost.YCH.BLL.收藏类别.娱乐推荐 %>&Id=<%=Adpost.YCH.Utility.Utils.GetQueryStringValue("Id") %>&RUrl=<%=Server.UrlEncode(Request.Url.ToString()) %>"><img src="../images/flow_list1.png"></a><a href="#"><img src="../images/flow_list2.png"></a><a href="#"><img src="../images/flow_list3.png">(<asp:Literal ID="ltrTalkCount" runat="server"></asp:Literal>条)</a></div>
            	<p>·&nbsp;电话：<asp:Literal ID="ltrTel" runat="server"></asp:Literal></p>
                <p>·&nbsp;地址：<asp:Literal ID="ltrAddress" runat="server"></asp:Literal></p>
                <p>·&nbsp;特色：<asp:Literal ID="ltrSpecial" runat="server" Visible="false"></asp:Literal></p>
                <div id="Monver">
                    <h2>娱乐预定<span id="close"></span></h2>
                    <div class="pane_content_list_show1_btn1"><a href="travel_entertainment_list.aspx">返回列表</a></div>
                    <table>
                            <tr>
                                <td width="20%" class="theme_td1">参与人数</td>
                                <td width="80%"><input type="text" class="lodge_input1" name="num"></td>
                            </tr>
                            
                            <tr>
                                <td class="theme_td1">预计参与时间</td>
                            ...
                            <tr>
                                <td colspan="2" class="theme_td1"><input type="hidden" id="hidId" name="hidId" runat="server" /><asp:Button ID="btnSave" CssClass="theme_input3" runat="server" Text="提 交" OnClick="btnSave_Click" /><input type="button" class="theme_input4" value="取 消"></td>
                            </tr>
                        </table>
            ...
            <div class="hotel_list1" id="firstpane">
                ...
                <div class="menu_body">
                    ...
                    <div class="picScrolla">
                    	<ul>
                        	<%#PhotoList(Convert.ToString(Eval("webphoto"))) %>
                        </ul>
                        <a class="prev"></a>
            			<a class="next"></a>
                    </div>
                    <!--<div class="hotel_list_btn" EID="<%#Eval("Id") %>"><a>预&nbsp;&nbsp;订</a></div>-->
                </div>
