...
<header>
    ...
    <nav>
      ...
      <div class="list-container">
        <ul>
          <li class="open-subnav travel-diary"> <a href="about/about_introduce.aspx" data-target-subnav="travel-diary">Impression Peninsula</a> </li>
          <li class="open-subnav villas"> <a href="traveling/travel_raiders_line.aspx" data-target-subnav="villas">Journey</a> </li>
          ...
          <div class="list-last">
            <p><span class="login">Sign in</span><span class="register">Registration</span></p>
            <p><a href="#">半岛政务网</a></p>
    ...
    <div class="subnavs">
      ...
      <a href="traveling/travel_food.aspx" class="ajax item num-2 garden-water-villas"> 
          ...
          <span class="picture retina" style="background-image:url('images/travel_img3.jpg');"> 
          	<img class="retina" height="100%" /> 
          </span> 
          <span class="separator"></span> 
      </a> 
      <a href="traveling/travel_hotel.aspx" class="ajax item num-3 art-recevoir"> 
          ...
          <span class="picture retina" style="background-image:url('images/travel_img4.jpg');"> 
          	<img class="retina" height="100%" /> 
          </span> 
          <span class="separator"></span> 
      </a>
      <a href="traveling/travel_shopping.aspx" class="ajax item num-3 art-recevoir"> 
          ...
          </span> <span class="picture retina" style="background-image:url('images/travel_img5.jpg');"> 
          	<img class="retina" height="100%" /> 
      ...
      <a href="traveling/travel_entertainment.aspx" class="ajax item num-3 art-recevoir"> 
          ...
          <span class="picture retina" style="background-image:url('images/travel_img6.jpg');"> 
          	<img class="retina" height="100%" /> 
          </span> 
          <span class="separator"></span> 
      </a> 
      ...
      <div class="subnav culinary-art count-5"> 
       ...
       <a href="about/about_map.aspx" class="ajax item num-1 water-villas"> 
          ...
          </span> <span class="picture retina" style="background-image:url('images/travel_img2.jpg');"> 
          	<img class="retina" height="100%" /> 
          </span> 
          <span class="separator"></span> 
      </a> 
      <a href="trip/trip_line.aspx" class="ajax item num-5 diptyque"> 
       ...
       <a href="traveling/travel_raiders_line.aspx" class="ajax item num-0 island-villas"> 
          ...
          <span class="picture retina" style="background-image:url('images/travel_img1.jpg');"> 
            <img class="retina" height="100%" /> 
          </span> 
          <span class="separator"></span> 
      </a>
  ...
  <div class="login">
    <div class="login_lt left">
      <table>
        <tr>
          <td width="18%">新密码：</td>
          <td><input type="password" class="login_input3" id="userpwd" ></td>
        </tr>
        <tr>
          <td>再次输入：</td>
          <td><input type="password" class="login_input3" ></td>
        </tr>
        <tr>
          <td></td>
          <td><span class="login_lt_btn">下一步</span></td>
        </tr>
      </table>
    </div>
